...
class CustomTextWidget{
  ...
  regularText({dynamic text,double size,Color color, TextAlign alignment}) {
    return Container(
        child: Text(text is Map?text[LANGUAGE_TYPE]:text,
  ...
  mediumText({dynamic text,double size,Color color, TextOverflow textOverFlow,TextAlign alignment}) {
    return Container(
        child: Text(text is Map?text[LANGUAGE_TYPE]:text,
          style: TextStyle(
              fontSize: size,
