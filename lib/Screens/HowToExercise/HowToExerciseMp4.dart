...
class HowToExerciseMp4 extends StatefulWidget {
  ...
  HowToExerciseMp4({@required this.ex_id, @required this.name});

  @override
  _HowToExerciseMp4State createState() => _HowToExerciseMp4State(this.name);
}

class _HowToExerciseMp4State extends State<HowToExerciseMp4> {
  String name;
  _HowToExerciseMp4State(this.name);
