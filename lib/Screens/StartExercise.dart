...
class _StartExerciseState extends State<StartExercise>
  ...
  Timer getReady10secTimerAction;
            ...
            children: [
              ...
              Expanded(
                  child: CachedNetworkImage(
                      ...
                      imageUrl: IMAGE_URL_MENU_ITEM + list[currentIndex].image,
                      progressIndicatorBuilder:
                          (context, url, downloadProgress) => Container(),
                      errorWidget: (context, url, error) =>
                          placeHolder(borderRadius: 10))),
              SizedBox(
                height: MediaQuery.of(context).size.height < 600 ? 10 : 20,
              ),
              Row(
                ...
                children: [
                            ...
                            MaterialPageRoute(
                                builder: (context) => PLAY_YOUTUBE_VIDEOS
                                    ? HowToExerciseYoutube(
                                        ex_id: list[currentIndex].id)
                                    : HowToExerciseMp4(
                                        ex_id: list[currentIndex].id)));
                        pauseOrPlay(isPlaying ? true : false);
                      },
                      child: Image.asset(
                        "assets/startExcercise/about.png",
                        height:
                            MediaQuery.of(context).size.height < 600 ? 25 : 40,
                        width:
                            MediaQuery.of(context).size.height < 600 ? 25 : 40,
                        fit: BoxFit.fill,
                      )),
                  ...
                  //     child: Image.asset(
                  //       isTickTickVolumeOn
                  //           ? "assets/startExcercise/volume.png"
                  //           : "assets/startExcercise/mute.png",
                  //       height:
                  //           MediaQuery.of(context).size.height < 600 ? 25 : 40,
                  //       width:
                  //           MediaQuery.of(context).size.height < 600 ? 25 : 40,
                  ...
                  //         }
                  //         isVoiceGuidanceOn
                  //             ? flutterTts.setVolume(volumeValue)
                  //             : flutterTts.setVolume(0);
                  //       });
                  //     },
                  //     child: Image.asset(
                  //       isVoiceGuidanceOn
                  //           ? "assets/startExcercise/mike.png"
                  //           : "assets/startExcercise/mike_mute.png",
                  //       height:
                  //           MediaQuery.of(context).size.height < 600 ? 25 : 40,
                  //       width:
                  //           MediaQuery.of(context).size.height < 600 ? 25 : 40,
              ...
              SizedBox(
                height: MediaQuery.of(context).size.height < 600 ? 5 : 15,
              ),
              Padding(
                                          ...
                                          children: [
                                            t.mediumText(
                                                text: int.parse(
                                                        ...
                                                        60
                                                    ? "00:00"
                                                    : "00:${(int.parse(list[currentIndex].timee) - completedExerciseTime) < 10 ? "0${(int.parse(list[currentIndex].timee) - completedExerciseTime)}" : (int.parse(list[currentIndex].timee) - completedExerciseTime)}",
                                                color: WHITE,
              ...
              SizedBox(
                height: MediaQuery.of(context).size.height < 600 ? 5 : 25,
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  InkWell(
                        ...
                        if (mounted) {
                          setState(() {
                            ...
                            completedExerciseTime =
                                int.parse(list[currentIndex].timee);
                            value = 0.0;
                            isPlaying = true;
                      ...
                      child: Image.asset(
                        "assets/startExcercise/prev.png",
                        height:
                  ...
                  InkWell(
                    onTap: () {
                      if (mounted) {
                        ...
                        print(
                            "1->" + rotationController.isCompleted.toString());
                      }
                    },
                    child: Container(
                      height:
                          MediaQuery.of(context).size.height < 600 ? 40 : 50,
                      width: 180,
                      child: Stack(
                        children: [
                          Container(
                  ...
                  InkWell(
                      ...
                      child: Image.asset(
                        "assets/startExcercise/next.png",
                        height:
                            MediaQuery.of(context).size.height < 600 ? 15 : 30,
                        width: 30,
                      ))
                ],
              ),
              SizedBox(
                height: MediaQuery.of(context).size.height < 600 ? 10 : 25,
              ),
      ...
      if (mounted) {
        setState(() {
          rotationController = AnimationController(
            duration: Duration(
                seconds: int.parse(list[currentIndex].timee.toString())),
            vsync: this,
          );
            ...
            if (rotationController.isAnimating) {
              ...
              if (mounted) {
                setState(() {
                  ...
                  completedExerciseTime =
                      (value * double.parse(list[currentIndex].timee)).toInt();
                  //print(value);
                });
              }
              ...
              if (previousCompletedExerciseTime < completedExerciseTime ||
                ...
                if (int.parse(list[currentIndex].timee) ~/ 2 ==
                    completedExerciseTime) {
                  voiceAssistant.speak(HALF_COMPLETED[LANGUAGE_TYPE]);
                }

                if ((int.parse(list[currentIndex].timee) -
                        completedExerciseTime) <
                    4) {
                  loadAudio321();
                  ...
                  //   volume: volume
                  // );
                  voiceAssistant.speak((int.parse(list[currentIndex].timee) -
                          completedExerciseTime)
                      .toString());
                } else {
                  // assetsAudioPlayer.open(
              ...
              if (mounted) {
                progressClass.addData(
                  ...
                  workOuts: "1",
                  seconds: list[currentIndex].timee.toString(),
                  context: context,
                );
                setState(() {
                  ...
                  value = 1.0;
                  completedExerciseTime = int.parse(list[currentIndex].timee);
              ...
              if (mounted) {
                setState(() {
                  ...
                  completedExerciseTime =
                      (value * double.parse(list[currentIndex].timee)).toInt();
                  print(
                      "completedExerciseTime = ${(value * double.parse(list[currentIndex].timee)).toInt()}");
                });
                rotationController.forward();
              }
            } else if (isPlaying) {
