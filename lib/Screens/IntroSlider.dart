...
class _IntroSliderState extends State<IntroSlider> with TickerProviderStateMixin{
  ...
  List<CustomWidgetClass> list = List();
  ...
  void initState() {
    ...
    setState(() {
      list.add(CustomWidgetClass(
        image: "assets/splash/1 crop.png",
        buttonText: BUTTON_TEXT1[LANGUAGE_TYPE],
        heading: HEADING1[LANGUAGE_TYPE],
        subHeading: SUB_HEADING1[LANGUAGE_TYPE],
        tagLine: TAG_LINE1[LANGUAGE_TYPE],
      ));
      list.add(CustomWidgetClass(
        image: "assets/splash/3 crop.png",
        buttonText: BUTTON_TEXT2[LANGUAGE_TYPE],
        heading: HEADING2[LANGUAGE_TYPE],
        subHeading: SUB_HEADING2[LANGUAGE_TYPE],
        tagLine: TAG_LINE2[LANGUAGE_TYPE],
      ));
      list.add(CustomWidgetClass(
        image: "assets/splash/2 crop.png",
        buttonText: BUTTON_TEXT3[LANGUAGE_TYPE],
        heading: HEADING3[LANGUAGE_TYPE],
        subHeading: SUB_HEADING3[LANGUAGE_TYPE],
        tagLine: TAG_LINE3[LANGUAGE_TYPE],
      ));
    });
                  ...
                  children: [
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: customWidgetClass.mediumText(text: SKIP,size: 18,color: LIGHT_GREY_TEXT)
                      ),
                    ),
                  ],
                ),
          ...
          onTap: (){
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: customWidgetClass.mediumText(text: BUTTON_TEXT1,size: 15,color: WHITE),
              ),
  ...
  customWidget(String image, String heading, String tagLine, String subHeading, String buttonText){
    return Column(
      children: [
        ...
        SizedBox(height: 20,),
        customWidgetClass.heavyText(text: heading,size: 30,color: BLACK),
       customWidgetClass.mediumText(text: subHeading,size: 20,color: DARK_GREY_TEXT),
        SizedBox(height: 10,),
        Container(
          margin: EdgeInsets.only(left: 60,right: 60),
          child: customWidgetClass.regularText(text: tagLine,size: 15,color: LIGHT_GREY_TEXT,alignment: TextAlign.center),
        ),
        SizedBox(height: 20,),
      ]
    );
